...
![ISO 27001](https://img.shields.io/badge/ISO%2027001-Information%20Security-0052CC?style=for-the-badge&logo=security)
...
- **Nombre:** Christell Baño Cordero  
- **GitHub:** `ChrisBaCor2002`  
...
- **Descripción:** Convertir datos en información estratégica usando Business Intelligence para apoyar la toma de decisiones organizacionales.
- **Tech Stack:** Google Trends, Excel/Sheets y herramientas ofimáticas para análisis de mercado, investigación y visualización de datos.
- **Repositorio:**  
...
- **Descripción:** Análisis integral de datos retail para identificar patrones de consumo, evaluar campañas y apoyar la toma de decisiones estratégicas mediante Excel avanzado.  
- **Repositorio:**  
👉 https://github.com/ChrisBaCor2002/ProyectoModuloExcel  

---

### 🤖 Sistema Automatizado de Evaluación de Propuestas de Negocio (Tesis)
- **Descripción:** Proyecto de Titulación orientado a la automatización del proceso de evaluación de propuestas de negocio mediante un chatbot basado en Inteligencia Artificial.  
- **Tech Stack:** Python, Flask, OpenAI API, PostgreSQL, HTML, CSS, JavaScript  
- **Repositorio:**  
👉 https://github.com/ChrisBaCor2002/Chatbot-InnovUG
